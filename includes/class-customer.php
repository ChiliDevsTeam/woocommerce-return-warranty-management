...
class WCRW_Customer {
    ...
    public function endpoint_title( $title ) {
        ...
        {
            $title = __( 'Request for a Warranty', 'wc-return-warranty-management' );
        ...
        {
            $title = __( 'Create New Request', 'wc-return-warranty-management' );
            remove_filter( 'the_title', array( $this, 'endpoint_title' ) );
        }
    ...
    public function warranty_requests_link( $menu_links ) {
        ...
        $menu_title = ! empty( $frontend_settings['myaccount_menu_title'] ) ? $frontend_settings['myaccount_menu_title'] : __( 'Warranty Requests', 'wc-return-warranty-management' );
    ...
    public function warranty_requests_content() {
        ...
        if( $total_page > 1 ){
            ...
            $page_links = paginate_links( array(
                ...
                'format'    => '',
                'type'      => 'array',
                'prev_text' => __( '&laquo; Previous', 'wc-return-warranty-management' ),
                'next_text' => __( 'Next &raquo;', 'wc-return-warranty-management' ),
                'total'     => $total_page,
                'current'   => $page
            ) );
    ...
    public function warranty_request_button( $actions, $order ) {
        ...
        $btn_text = ! empty( $frontend_settings['request_btn_label'] ) ? $frontend_settings['request_btn_label'] : __( 'Request Warranty', 'wc-return-warranty-management' );
