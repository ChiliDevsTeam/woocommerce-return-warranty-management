...
class WCRW_Handle_Form {
    ...
    public function handle_request_submission_form() {
        ...
        wc_add_notice( __( 'Request has been submitted successfully', 'wc-return-warranty-management' ), 'success' );
    ...
    public function handle_status_action() {
        ...
        $url = add_query_arg( [ 'page' => 'wc-return-warranty-management', 'updated' => 1, 'message' => 'status_updated' ], admin_url( 'admin.php' ) );
        wp_redirect( $url );
        exit();
    }
}
